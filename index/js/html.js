...
function do_js_beautify() {
    ...
    js_source = document.getElementById('codecontent').value.replace(/^\s+/, '');
    ...
    if (js_source && js_source.charAt(0) === '<') {
        document.getElementById('codecontent').value = style_html(js_source, tabsize, tabchar, 80);
    } else {
        document.getElementById('codecontent').value = js_beautify(js_source, tabsize, tabchar);
    }
    document.getElementById('beautify').disabled = false;
    return false;
}
function pack_js(base64) {
    var input = document.getElementById('codecontent').value;
    ...
    document.getElementById('codecontent').value = output;
}
function Empty() {
