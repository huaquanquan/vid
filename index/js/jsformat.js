/**
 * Created by vqianduan on 15/6/3.
 */
function do_js_beautify() {
    //document.getElementById('beautify').disabled = true;
    js_source = document.getElementById('jian').value.replace(/^\s+/, '');
    tabsize = document.getElementById('tabsize').value;
    tabchar = ' ';
    if (tabsize == 1) {
        tabchar = '\t'
    }
    document.getElementById('fan').value = js_beautify(js_source, tabsize, tabchar);
    /*
    if (js_source && js_source.charAt(0) === '<') {
        document.getElementById('fan').value = style_html(js_source, tabsize, tabchar, 80)
    } else {
...
function pack_js(base64) {
    var input = document.getElementById('jian').value;
    ...
    document.getElementById('fan').value = output
}
function Empty() {
    document.getElementById('jian').value = '';
    document.getElementById('jian').select()
}
function GetFocus() {
